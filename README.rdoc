= Indent
{<img src="https://travis-ci.org/indentlabs/Indent.png?branch=master" alt="Build Status" />}[https://travis-ci.org/indentlabs/Indent]
{<img src="https://coveralls.io/repos/indentlabs/Indent/badge.svg?branch=master" alt="Coverage Status" />}[https://coveralls.io/r/indentlabs/Indent?branch=master]
{<img src="http://inch-ci.org/github/indentlabs/Indent.svg?branch=master" alt="Inline docs" />}[http://inch-ci.org/github/indentlabs/Indent]
{<img src="https://hakiri.io/github/indentlabs/Indent/master.svg" alt="security" />}[https://hakiri.io/github/indentlabs/Indent/master]
