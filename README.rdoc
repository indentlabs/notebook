...
{<img src="https://coveralls.io/repos/drusepth/Indent/badge.svg?branch=master" alt="Coverage Status" />}[https://coveralls.io/r/drusepth/Indent?branch=master]
{<img src="http://inch-ci.org/github/drusepth/Indent.svg?branch=master" alt="Inline docs" />}[http://inch-ci.org/github/drusepth/Indent]
{<img src="https://hakiri.io/github/drusepth/Indent/master.svg" alt="security" />}[https://hakiri.io/github/drusepth/Indent/master]
